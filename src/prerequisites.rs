...
pub(crate) const TYPES: &[(&str, &[Entry], &[&str])] = &[
    ...
    ("google_compute_network_firewall_policy", &[project("compute.firewallPolicies.create", &["roles/compute.securityAdmin"])], &["compute.googleapis.com"]),
    (
        "google_compute_network_firewall_policy_association",
        &[project("compute.networks.setFirewallPolicy", &["roles/compute.networkAdmin"])],
        &["compute.googleapis.com"],
    ),
    ("google_compute_network_firewall_policy_rule", &[project("compute.firewallPolicies.update", &["roles/compute.securityAdmin"])], &["compute.googleapis.com"]),
    ...
    ("google_compute_shared_vpc_host_project", &[org("compute.organizations.enableXpnHost", &["roles/compute.xpnAdmin"])], &["compute.googleapis.com"]),
