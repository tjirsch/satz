...
# `monitoring.organization_cis_log_alerts_central` — version 1.6
...
params {
  ...
  cis_central_bucket_project = logsink_project_id
...
| version | date | change |
|---|---|---|
| 1.6 | 2026-09-12 | follows the rename: the alert project defaults to `logsink_project_id` |
