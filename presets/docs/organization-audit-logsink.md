...
# `monitoring.organization_audit_logsink` — version 1.3
...
|---|---|---|---|---|
| `logsink_project_name` | The project that holds the audit-log archive | recreate | high | — |
...
**logsink_project_name** — A project id is immutable. Changing it later creates a second project and abandons the first, with the archive bucket inside it — and every pack that points at the logging project by reference moves with it.
