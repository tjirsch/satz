...
# `integrations.microsoft_defender_for_cloud` — version 0.3
...
and it is created wherever `mdc_mgmt_project_folder` says — at the organisation
while that param says nothing.
