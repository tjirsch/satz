...
# `essential_contacts_organization` — version 1.4

Source: `presets/essential-contacts-organization.satz`
...
| version | date | change |
|---|---|---|
| 1.4 | 2026-09-20 | the header loses the word `content`, which the language no longer has: a pack header is a name and a version. Nothing emitted changes. A copy of 1.3 is refused by its header line — see Breaking changes |
