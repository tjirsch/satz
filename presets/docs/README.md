...
**35 packs · 167 resources · 81 claims over cis-gcp 4.0 and cis-gcp 5.0.**
...
| [`estate_map`](estate-map.md) | 1.4 | The map: which packs make up this estate, asked as questions — so an interview has a path. | 0 | — |
