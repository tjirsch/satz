...
**39 packs · 202 resources · 82 claims over cis-gcp 4.0 and cis-gcp 5.0.**

## Root — `presets/*.satz`

| pack | version | what it does | resources | claims |
|---|---|---|---|---|
| [`CIS_GCP_Foundation_4_0`](CIS-GCP-Foundation-4.0.md) | 2.10 | The CIS GCP Foundation 4.0 organization-policy set, managed constraints included. | 25 | 29 — cis-gcp 4.0, cis-gcp 5.0 |
