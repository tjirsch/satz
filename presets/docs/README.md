...
| [`estate_core`](estate-core.md) | 2.2 | The questions every estate has to answer on day 0, with the params they answer. | 0 | — |
| [`estate_map`](estate-map.md) | 2.3 | The map: which packs make up this estate, asked as questions — so an interview has a path. | 0 | — |
| [`interface_notice`](interface-notice.md) | 1.0 | Tells the teams whose HCL reads this estate's interface when an exported value changes: one Pub/Sub message per apply that changes one. | 5 | — |
