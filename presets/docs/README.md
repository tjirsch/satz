...
| [`estate_map`](estate-map.md) | 1.9 | The map: which packs make up this estate, asked as questions — so an interview has a path. | 0 | — |
...
| pack | version | what it does | resources | claims |
|---|---|---|---|---|
| [`CIS_GCP_Foundation_4_0`](CIS-GCP-Foundation-4.0.md) | 2.14 | The CIS GCP Foundation 4.0 organization-policy set, managed constraints included. | 25 | 30 — cis-gcp 4.0, cis-gcp 5.0 |
...
| [`cis_extensions.api_key_services_dry_run`](api-key-services-dry-run.md) | 1.1 | GENERATED by scripts/build_dry_run_fragments.py from api-key-services.satz — do not edit. | 1 | — |
...
| [`cis_extensions.block_project_ssh_keys_dry_run`](block-project-ssh-keys-dry-run.md) | 1.0 | GENERATED by scripts/build_dry_run_fragments.py from block-project-ssh-keys.satz — do not edit. | 1 | — |
...
| [`cis_extensions.bucket_retention_dry_run`](bucket-retention-dry-run.md) | 1.2 | GENERATED by scripts/build_dry_run_fragments.py from bucket-retention.satz — do not edit. | 2 | — |
...
| [`cis_extensions.cloud_sql_dry_run`](cloud-sql-dry-run.md) | 1.1 | GENERATED by scripts/build_dry_run_fragments.py from cloud-sql.satz — do not edit. | 4 | — |
| [`cis_extensions.cloud_sql_iam_and_deletion_protection_dry_run`](cloud-sql-iam-and-deletion-protection-dry-run.md) | 1.0 | GENERATED by scripts/build_dry_run_fragments.py from cloud-sql-iam-and-deletion-protection.satz — do not edit. | 4 | — |
...
| [`cis_extensions.confidential_computing_dry_run`](confidential-computing-dry-run.md) | 1.0 | GENERATED by scripts/build_dry_run_fragments.py from confidential-computing.satz — do not edit. | 1 | — |
