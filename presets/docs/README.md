...
| [`estate_core`](estate-core.md) | 2.3 | The questions every estate has to answer on day 0, with the params they answer. | 0 | — |
| [`estate_map`](estate-map.md) | 2.4 | The map: which packs make up this estate, asked as questions — so an interview has a path. | 0 | — |
| [`interface_notice`](interface-notice.md) | 1.1 | Tells the teams whose HCL reads this estate's interface when an exported value changes: one Pub/Sub message per apply that changes one. | 5 | — |
...
| pack | version | what it does | resources | claims |
|---|---|---|---|---|
| [`CIS_GCP_Foundation_4_0`](CIS-GCP-Foundation-4.0.md) | 2.17 | The CIS GCP Foundation 4.0 organization-policy set, managed constraints included. | 25 | 30 — cis-gcp 4.0, cis-gcp 5.0 |
...
| [`cis_extensions.api_key_services_dry_run`](api-key-services-dry-run.md) | 1.3 | GENERATED by scripts/build_dry_run_fragments.py from api-key-services.satz — do not edit. | 1 | — |
| [`cis_extensions.api_key_services`](api-key-services.md) | 1.3 | CIS 4.0 §1.14 / 5.0 §1.15 — API keys restricted to the APIs an application needs. | 1 | 2 — cis-gcp 4.0, cis-gcp 5.0 |
| [`cis_extensions.block_project_ssh_keys_dry_run`](block-project-ssh-keys-dry-run.md) | 1.2 | GENERATED by scripts/build_dry_run_fragments.py from block-project-ssh-keys.satz — do not edit. | 1 | — |
| [`cis_extensions.block_project_ssh_keys`](block-project-ssh-keys.md) | 1.2 | CIS 4.3 — block project-wide SSH keys. | 1 | 2 — cis-gcp 4.0, cis-gcp 5.0 |
| [`cis_extensions.bucket_retention_dry_run`](bucket-retention-dry-run.md) | 1.4 | GENERATED by scripts/build_dry_run_fragments.py from bucket-retention.satz — do not edit. | 2 | — |
| [`cis_extensions.bucket_retention`](bucket-retention.md) | 1.4 | CIS 4.0 §2.3 / 5.0 §2.4 — retention on the log-export bucket. | 2 | 2 — cis-gcp 4.0, cis-gcp 5.0 |
| [`cis_extensions.cloud_sql_dry_run`](cloud-sql-dry-run.md) | 1.3 | GENERATED by scripts/build_dry_run_fragments.py from cloud-sql.satz — do not edit. | 4 | — |
| [`cis_extensions.cloud_sql_iam_and_deletion_protection_dry_run`](cloud-sql-iam-and-deletion-protection-dry-run.md) | 1.2 | GENERATED by scripts/build_dry_run_fragments.py from cloud-sql-iam-and-deletion-protection.satz — do not edit. | 4 | — |
| [`cis_extensions.cloud_sql_iam_and_deletion_protection`](cloud-sql-iam-and-deletion-protection.md) | 1.2 | CIS 5.0 §6.6 / §6.9 — Cloud SQL instances sign database users in through IAM, and cannot be deleted while deletion protection is on. | 4 | 2 — cis-gcp 5.0 |
| [`cis_extensions.cloud_sql`](cloud-sql.md) | 1.3 | CIS 6.5 and 6.6/6.7 — Cloud SQL network exposure. | 4 | 4 — cis-gcp 4.0, cis-gcp 5.0 |
| [`cis_extensions.cmek`](cmek.md) | 1.3 | CIS 7.2, 7.3 and 8.1 — customer-managed encryption keys. | 2 | 6 — cis-gcp 4.0, cis-gcp 5.0 |
| [`cis_extensions.confidential_computing_dry_run`](confidential-computing-dry-run.md) | 1.2 | GENERATED by scripts/build_dry_run_fragments.py from confidential-computing.satz — do not edit. | 1 | — |
| [`cis_extensions.confidential_computing`](confidential-computing.md) | 1.2 | CIS 4.11 — Confidential Computing. | 1 | 2 — cis-gcp 4.0, cis-gcp 5.0 |
| [`cis_extensions.dns_logging`](dns-logging.md) | 1.2 | CIS 5.0 §2.13 — DNS query logging, as far as an org policy can carry it. | 2 | 1 — cis-gcp 5.0 |
...
| [`cis_extensions.shielded_vm`](shielded-vm.md) | 1.2 | CIS 4.8 — Shielded VM. | 1 | 2 — cis-gcp 4.0, cis-gcp 5.0 |
...
| pack | version | what it does | resources | claims |
|---|---|---|---|---|
| [`monitoring.organization_audit_logsink`](organization-audit-logsink.md) | 1.6 | Organization-wide audit log sink into a GCS bucket — the compliance archive. | 5 | 6 — cis-gcp 4.0, cis-gcp 5.0 |
...
| [`scc_findings_siem`](scc-findings-siem.md) | 1.0 | Security Command Center findings, pulled off the topic by an external SIEM. | 2 | — |
...
|---|---|---|---|
| cis-gcp 4.0 | 38 | 35 | 2.12, 2.13, 2.14 |
| cis-gcp 5.0 | 45 | 40 | 1.1.1, 1.1.2, 1.1.3, 2.2, 2.15 |
