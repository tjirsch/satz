...
| `satz_prowler` | `read` | the Prowler invocation this estate needs — frameworks, projects, and an output path named for the UTC minute, so no two scans share a file. It prints the command; nothing runs the scanner |
